...
setup(
    ...
    install_requires=[
        ...
        'dbt-adapters>=1.17.0,<1.18.0',  # This version should be dbt-adapters>=1.17,<2.0, but keeping it fixed for now to avoid unexpected issues. We need to frequently update it.
