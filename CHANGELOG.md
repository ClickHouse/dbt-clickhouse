...
* Materialized view targets with `catchup=false` now create configured projections and indexes. Previously only the catchup=true path called `add_index_and_projections` ([#637](https://github.com/ClickHouse/dbt-clickhouse/issues/637)).
