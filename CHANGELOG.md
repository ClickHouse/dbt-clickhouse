...
* Apply column-level `codec` and `ttl` to distributed models on create and on add/modify column. Storage clauses now target the shard-local table instead of the Distributed proxy.
