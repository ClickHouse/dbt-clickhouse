...
<Note>
**dbt OSS.** ClickHouse is supported in dbt OSS, the open-source (Apache 2.0) version of v2. See [terminology and availability](#terminology) for more information.
</Note>
